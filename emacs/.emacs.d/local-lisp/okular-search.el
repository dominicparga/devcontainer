...
is used (which see)."
  ...
  (save-excursion
    (save-restriction
      ...
      (beginning-of-line 1)
      (let* (
             ;; current line in file, as found in the documentation
        ...
        (setq mycommand (concat "okular --unique " myargs))
        (start-process-shell-command "okular" "*okular-output*" mycommand)
        ;; (message mycommand)
        ))))
